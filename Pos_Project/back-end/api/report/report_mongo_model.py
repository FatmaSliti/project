from mongoengine import ListField, ReferenceField, Document, DynamicDocument, StringField, IntField, FloatField
...
# # Create an instance of ShiftReport
# shift_report_instance = ShiftReport(ArticleID=2, lpn='EFH456', price=12, carteType='TypeB', duration='4 hours')

# # # Save the instance to the database
# shift_report_instance.save()
