...
//   const handleRequestSuccessChange = (value: boolean) => {
//     setRequestSuccess(value);
//   };
...
// const BarrierSection: React.FC<{ sendDataToParent: (data: any) => void }> = ({ sendDataToParent }) => {
//   const intl = useIntl();
//   const [clickedButton, setClickedButton] = useState<number | null>(null);
//   const [requestSuccess, setRequestSuccess] = useState<boolean>(false);
...
//         // Send data to parent indicating which button was clicked
//         sendDataToParent(index); // Here we send the index of the button clicked
//       }
//     } catch (error) {
//       console.error('Error:', error);
//     }
...
const BarrierSection: React.FC<{ sendDataToParent: (data: number) => void }> = ({ sendDataToParent }) => {
  const intl = useIntl();
  const [clickedButton, setClickedButton] = useState<number | null>(null);
  const [requestSuccess, setRequestSuccess] = useState<boolean>(false);
